...
{ 
    ...
    public void placeRoom(GameObject[] room, GameObject door, bool isFirstRoom)//probably wont use this, but switchc
    {
        ...
        if (isFirstRoom == true)
        {
            ...
            {
                case Dir.Up:
                    newYPos = new Vector3((room[0].transform.position.x / 2), (room[0].transform.position.y / 2));
                    break;
                case Dir.Down:
                    newYPos = new Vector3((room[0].transform.position.x / 2), (room[0].transform.position.y / 2));
                    break;
                case Dir.Left:
                    newXPos = new Vector3((room[0].transform.position.x / 2), (room[0].transform.position.y / 2));
                    break;
                case Dir.Right:
                    newXPos = new Vector3((room[0].transform.position.x / 2), (room[0].transform.position.y / 2));
                    break;
